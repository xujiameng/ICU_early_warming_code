...
# 程序流程：
#       Step1：提取不同特征子集下的BER数值，选取其中最小的作为对应的最优特征子集的特征量
#       Step2：寻找BER一直严格下降的最大子集，其余置为NAN
#       Step3：寻找BER图像下降阶段终点与平缓阶段的起点
#       Step4：寻找两个关键点间性价比最优的BER与特征量的映射关系，对应的特征量即为最小特征子集的特征量
% 程序运行结果：输出最优特征子集与最小特征子集的特征量
