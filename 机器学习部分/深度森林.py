...
ca_config["estimators"].append(
        {"n_folds": 10, "type": "XGBClassifier", "n_estimators": 5000, "max_depth": 5,"min_child_weight": 5,"colsample_bytree": 0.8,
         "silent": True, "nthread": -1, "learning_rate": 0.01,"objective":'rank:pairwise'} )
